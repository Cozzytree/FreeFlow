      ...
      <>
         ...
         >
            ...
            {tweetComments?.pages[0]?.data?.data?.map((comment, index) => (
               <div
                  key={comment._id}
                  className="grid grid-cols-[auto_1fr_auto] gap-4 pb-2 w-[100%] relative p-3 border-b-[1px] border-b-zinc-500/50"
               >
                  <img
                  ...
                  <div className="flex flex-col">
                     ...
                     {isEdit === index ? (
                        <form
                           ...
                           className="flex flex-col justify-start gap-1 items-center"
                        >
                           <FormInput
                              inpurRef={inputRef}
                              type="text"
                           ...
                           <div className="flex gap-2 items-center">
                              <span
                                 className="text-xs sm:text-sm md:text-md font-medium cursor-pointer"
                              ...
                              <Button
                                 ...
                                 extrastyles={`rounded-md ${
                                    isEditingTweetComentm && "cursor-wait"
                                 }`}
